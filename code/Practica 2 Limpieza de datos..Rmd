...
En primer lugar, frealizamos la carga del fichero que contiene los datos para nuestro análisis en formato csv, el cual está delimitado por comas y los decismales "·". Obtenemos como resultado de la llamada a la función read.csv() será un objeto data.frame.
 
```{r, echo=TRUE}
# read data
games <- read.csv("/Users/moreybagarciacedres/Downloads/android-games.csv", header=TRUE, sep=",", na.strings="NA", dec=".", strip.white=TRUE)
n.var <- names(games)
